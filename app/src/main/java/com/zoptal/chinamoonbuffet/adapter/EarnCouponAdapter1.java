...
import com.zoptal.chinamoonbuffet.JsonClasses.Json_RedeeminpersonEarn;
...
public class EarnCouponAdapter1 extends BaseAdapter {

	LayoutInflater inflater;
	Context context ;
	Model_EarnCoupon m;
	ArrayList<Earncouponcode> al_earncoupon;
	public static String id;

	public EarnCouponAdapter1(Context context, ArrayList<Earncouponcode> al_earncoupon) {
			...
			public void onClick(View v) {
				...
				btn_yes.setOnClickListener(new View.OnClickListener() {
					...
					public void onClick(View v) {
						...
						new Json_RedeeminpersonEarn(context).execute(Fragment_Menu.access_tokn,al_earncoupon.get(position).getId(),"earned");
