...
public class PayPalIntegrationActivity1 extends ActionBarActivity {
...
//			.clientId("Ae6QnxsdQgyUZSzuMSA306aEbaAf6RFe4ea934EgWtow7knriA_O3qcLI1exXEUgnng3zFZ4HyLhFkfT").merchantName("ChinaMoonBuffet");
	...
	//	txt_address=(EditText)findViewById(R.id.ed_address);
		...
		tv_delivery.setText(Json_DeliveryDistance.deliveryDistance.getDelivery_fee());

		listView=(ListView)findViewById(R.id.listView);

		new Json_MyCartList1(PayPalIntegrationActivity1.this,listView).execute(Fragment_Menu.access_tokn);

		total_chrges.setText("$"+Json_MyCartList.tamt);
		dchrge= Double.parseDouble(Json_DeliveryDistance.deliveryDistance.getDelivery_fee());
		...
		Log.e("grandtotal iiii=====",""+grandtotal);
...
//				fragmentManager.beginTransaction().replace(R.id.activity_main_content_fragment, fragment).commit();
				...
				Intent i = new Intent(PayPalIntegrationActivity1.this, MainActivity.class);
				startActivity(i);
...
//		startActivityForResult(intent, 0);
		...
		PayPalPayment payment = new PayPalPayment(new BigDecimal(grandtotal), "USD", "sample item",
				PayPalPayment.PAYMENT_INTENT_SALE);
			...
			if (confirm != null) {
				try {
				 ...
				 String paymentAmount=grandtotal;
					...
					startActivity(new Intent(this, ConfirmationActivity1.class)
