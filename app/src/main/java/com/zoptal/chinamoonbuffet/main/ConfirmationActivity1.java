...
public class ConfirmationActivity1 extends AppCompatActivity {
    ImageView img_bck;
    Button btn_ok;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img_bck.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(ConfirmationActivity1.this, MainActivity.class);
                startActivity(i);
    ...
    private void showDetails(JSONObject jsonDetails, String paymentAmount) throws JSONException {
        ...
        new Json_PaymentSuccess(ConfirmationActivity1.this).execute(Fragment_Menu.access_tokn, Json_MyCartList.uniq,create_tym,id,Json_DeliveryDistance.deliveryDistance.getDelivery_fee(),PayPalIntegrationActivity1.grandtotal,"Delivery");
    }
    }
