...
public class Json_MenuData extends AsyncTask<String, String, String> {


    Context context;
    String coderesponse;
    ProgressDialog loading;
    public static Model_MenuData model_menudata=new Model_MenuData();
    public CustomListAdapter adapter_customlist;

    public Json_MenuData(Context context,CustomListAdapter adapter_customlist) {
        // TODO Auto-generated constructor stub
        this.context = context;
        this.adapter_customlist=adapter_customlist;
