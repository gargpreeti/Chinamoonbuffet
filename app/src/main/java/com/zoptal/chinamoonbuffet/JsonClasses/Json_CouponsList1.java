...
public class Json_CouponsList1 extends AsyncTask<String, String, String> {

    Context context;
    String coderesponse;
    ProgressDialog loading;
    public static Model_CouponsData model_couponsData=new Model_CouponsData();
    public CouponsAdapter couponsAdapter;

    public Json_CouponsList1(Context context, CouponsAdapter couponsAdapter) {
