...
import java.util.List;
 ...
 public class Json_RedeeminpersonEarn extends AsyncTask<String, String, String> {

    Context context;
    String msg,coderesponse;
    ProgressDialog loading;

   public Json_RedeeminpersonEarn(Context context) {
    ...
    protected void onPostExecute(String result) {
      ...
      //  Coupon Successfully Redeemed
        ...
        new Json_Earncoupn1(context, Fragment_Coupons.listView1).execute(Fragment_Menu.access_tokn, "1", "20");
