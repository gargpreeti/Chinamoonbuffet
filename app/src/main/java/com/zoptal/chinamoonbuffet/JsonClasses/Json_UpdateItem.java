...
public class Json_UpdateItem extends AsyncTask<String, String, String> {

    Context context;
    String msg,coderesponse;
   ProgressDialog loading;
   MainActivity activity1;
       public Json_UpdateItem(Context context) {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            nameValuePairs.add(new BasicNameValuePair("cart_id",params[3]));
            ...
            if (entity != null) {
             ...
             Log.e("updt cart result------",""+result1.trim());
