...
public class Json_SignUp extends AsyncTask<String, String, String> {
 ...
 public Json_SignUp(Context context) {
    ...
    protected String doInBackground(String... params) {
        ...
        HttpPost httppost = new HttpPost(RegisterUrl.register);
        ...
        try {
            ...
            nameValuePairs.add(new BasicNameValuePair("device_token",params[8]));
            nameValuePairs.add(new BasicNameValuePair("device_type",params[9]));
            nameValuePairs.add(new BasicNameValuePair("image",params[10]));
            nameValuePairs.add(new BasicNameValuePair("firebase_registration_id",params[11]));




            Log.e("total input----",""+nameValuePairs);
            ...
            if (entity != null) {
             ...
             Log.e("signup result------",""+result1.trim());
    ...
    protected void onPostExecute(String result) {
       ...
       if (coderesponse.equals("200")) {
           ...
           Log.e("access tokn--",""+access_token);
