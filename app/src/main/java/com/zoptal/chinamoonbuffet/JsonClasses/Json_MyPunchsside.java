...
public class Json_MyPunchsside extends AsyncTask<String, String, String> {
...
//public static String tamt;
    ...
    public Json_MyPunchsside(Context context) {
    ...
    protected void onPostExecute(String result) {
        ...
        if (coderesponse.equals("200")) {
                ...
                Fragment fragment=new Fragment_MyPunchesSide();
