...
import com.zoptal.chinamoonbuffet.adapter.MyPunchsAdapterP;
import com.zoptal.chinamoonbuffet.fragment.Fragment_MyPunchesSide;
...
public class Json_MyPunchsListP extends AsyncTask<String, String, String> {
  ...
  public  MyPunchsList mypunchlist;
    ...
    public Json_MyPunchsListP(Context context, ListView list) {
...
Log.e("reurd pucnnn",""+requiredpunch);
                Fragment_MyPunchesSide.tv_msg.setVisibility(View.VISIBLE);
            }
            else{

                Fragment_MyPunchesSide.tv_msg.setVisibility(View.GONE);
            ...
            list.setAdapter(new MyPunchsAdapterP(context,al_mypunchlist));
        }
        else{
