...
public class Fragment_DeliveryMap extends Fragment implements OnMapReadyCallback {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.dialog_deliverymap, container, false);
...
//        });
    ...
    public void onMapReady(GoogleMap map) {
        LatLng latLng = new LatLng(30.6869908,76.6627703);
