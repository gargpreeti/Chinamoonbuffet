...
import com.zoptal.chinamoonbuffet.adapter.OrderHistoryAdapterDetail;
import com.zoptal.chinamoonbuffet.main.MainActivity;


public class Fragment_orderhistoryDetail extends Fragment {

    MainActivity activity1;
    ListView listView;

    public TextView tv_msg;
    OrderHistoryAdapterDetail adapter_customlist;
   @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        activity1.tv_main.setText("      Order History Detail");
       ...
       adapter_customlist= new OrderHistoryAdapterDetail(getActivity(), Json_OrderHistoryDetail.al_orderhistory);
