...
public class Fragment_howwrksLoyaltyProgram extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       getActivity().getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_ADJUST_PAN);
        ...
        activity1.tv_main.setText("          HOW DOES IT WORK?");
    ...
    //    new Json_Aboutus(getActivity()).execute();
        ...
        webView.loadUrl(RegisterUrl.howworks);
    ...
    private class MyWebViewClient extends WebViewClient {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            view.loadUrl(RegisterUrl.howworks);
            return true;
        }
    }
